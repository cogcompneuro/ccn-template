// -----------------------------------------------------------------------
// CCN Conference - Extended Abstract Track Template (Typst)
...
//   "extended-abstract" camera-ready (after acceptance)
#show: ccn.with(
  mode: "submission",
  // mode: "extended-abstract",

  title: [Formatting Instructions for CCN 2026 Extended Abstracts],
...
longer than 2 pages. If needed, references may extend onto additional pages.
...
An *Acknowledgments* section may appear before the references to include author
contributions. Use of automated tools (such as generative AI) must be disclosed
in this section, describing the tools used and their role (e.g., drafting,
editing, code generation). Technical appendices are not permitted for extended
abstracts.
